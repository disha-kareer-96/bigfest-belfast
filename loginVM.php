...
<html>
    ...
    <body>
        ...
        if(isset($_POST["sign"])){
            ...
            $findusername = "SELECT * FROM users INNER JOIN venuemanagers ON venuemanagers.loginid = users.id INNER JOIN admin ON admin.adminid = users.loginid WHERE username = '$usernamedata' AND password=MD5('$passworddata')";
            ...
            if($rowcount > 0){
                ...
                while($row2 = $signinresult->fetch_assoc()){
                    ...
                    if($persontype == 1){
                        ...
                        header("Location:secure/adminhome.php?filter=$adminid");
                        
                    } elseif($persontype == 2) {
                        
                       header("Location:secure/venuemanagerhome.php?filter=$managerid");
