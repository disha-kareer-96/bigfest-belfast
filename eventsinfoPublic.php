...
?>  <?php 
        ...
        If ($DeleteFlag == "Y") {  
         ...
         $link_address = "DeleteReview.php?DeleteFlag=Y&ReviewID=$ReviewID&PerformerID=$getPerformerID&ScheduleID=$getScheduleID";
            
        echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" ;        
        echo "<a href='".$link_address."'>Delete Review</a>";
