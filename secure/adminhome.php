...
<ul class="topnav" id="myTopnav2">
  ...
  <li class="-icon">
	...
	<div class="col m3"><div class="card" style="width:300px">
                ...
                <button class="_small _yellow"onclick="window.location.href = 'homeoptions.php';">Click Here</button>
                </div>
                </div>
        </div>
        ...
        <div class="col m6"><div class="card" style="width:300px">
                ...
                <div class="-content _alignCenter">
                <strong>User Functions</strong>
                <p>Click here to edit user details.</p>
                <button class="_small _yellow" onclick="window.location.href = 'userfunctions.php';">Click Here</button>
                </div>
                </div>
        </div>	
</div>
